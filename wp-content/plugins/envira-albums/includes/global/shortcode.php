                            ...
                            foreach ( $gallery['gallery'] as $image_id => $image ) {
                                ...
                                if ( $this->get_config( 'thumbnails', $data ) ) {
                                    $image['thumb'] = Envira_Gallery_Common::get_instance()->resize_image( 
                                        $image['src'], 
                                        $this->get_config( 'thumbnails_width', $data ),
                                        $this->get_config( 'thumbnails_height', $data ),
                                        true,   // Crop
                                        'c',    // Position
                                        100,    // Quality
                                        false   // Retina
        ...
        $template  = '<div id="envirabox-buttons">';
            $template .= '<ul>';
                ...
                if ( $this->get_config( 'toolbar_title', $data ) ) {
                    $template .= '<li id="envirabox-buttons-title"><span>' . addslashes( $gallery['config']['title'] ) . '</span></li>';
